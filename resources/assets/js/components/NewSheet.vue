<template>
    <!-- Modal -->
    <div class="modal fade" id="new-sheet" tabindex="-1" role="dialog" aria-labelledby="new-sheet" aria-hidden="true">
    ...
    export default {
        ...
        methods: {
            save(){
                ...
                axios.post('http://esheet.test/sheets', {
